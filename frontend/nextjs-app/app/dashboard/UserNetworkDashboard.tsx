...
const circleAttachmentTypes=new Set(['image/jpeg','image/png','image/webp','image/gif','image/bmp','image/tiff','image/avif','image/heic','image/heif','image/x-icon','image/svg+xml','image/vnd.adobe.photoshop','image/x-adobe-dng','image/x-canon-cr2','image/x-nikon-nef','image/x-sony-arw','model/gltf-binary','model/gltf+json','model/obj','model/stl','model/3mf','model/vnd.usdz+zip','model/vnd.collada+xml','application/vnd.autodesk.fbx','application/ply','application/x-blender','video/mp4','video/webm','audio/mpeg','audio/mp3','audio/mp4','audio/x-m4a','audio/wav','audio/x-wav','audio/webm','audio/ogg','application/pdf','text/plain','application/msword','application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/vnd.ms-excel','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.presentationml.presentation']);
const circleAttachmentExtensions=new Set(['jpg','jpeg','jfif','png','webp','gif','bmp','tif','tiff','avif','heic','heif','ico','svg','psd','dng','cr2','nef','arw','glb','gltf','obj','stl','fbx','3mf','dae','ply','usdz','blend','mp4','webm','mp3','m4a','wav','ogg','pdf','txt','doc','docx','xls','xlsx','ppt','pptx']);
