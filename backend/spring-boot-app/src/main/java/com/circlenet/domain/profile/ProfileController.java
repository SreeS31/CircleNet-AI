...
public class ProfileController {
 private final ProfileService service; private final ProfileMediaStorage storage; public ProfileController(ProfileService service,ProfileMediaStorage storage){this.service=service;this.storage=storage;}
