...
public class CircleConversationService {
  ...
  private final UserProfileRepository profiles; private final CircleMediaStorage storage;
  public CircleConversationService(CircleRepository circles,CirclePostRepository posts,UserRepository users,UserProfileRepository profiles,CircleMediaStorage storage){this.circles=circles;this.posts=posts;this.users=users;this.profiles=profiles;this.storage=storage;}
  ...
  public CirclePostDto create(Long userId,Long circleId,Long parentPostId,String message,MultipartFile file){
    ...
    return dto(posts.save(post),userId);
  }
